...
> **Nota:** Esta analise foi feita antes da correcao de data leakage (Fase 3). Os resultados dos dados reais aqui estavam inflados. Ver RESULTADOS_FASE3.md para resultados corrigidos.
