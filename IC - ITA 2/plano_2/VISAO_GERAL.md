...
|:-----:|:----:|-----------|:----------:|:-----------:|:------:|
| 1 | 05-A | **Classificação hierárquica + LLM no Nível 2** (CORE) | 2-3 dias | Nenhuma | PENDENTE |
| 2 | 04-B | Ablação completa + significância estatística | 1-2 dias | Nenhuma | PENDENTE |
| 3 | 06 | MechDetect como baseline de comparação | 1-2 dias | Nenhuma | PENDENTE |
| 4 | 07 | PKLM como baseline / feature | 1-2 dias | Nenhuma | PENDENTE |
| 5 | 05-B | LOGO Cross-Validation | 1 dia | Steps 1-4 | PENDENTE |
| 6 | 08 | Análise SHAP + Error Analysis | 1-2 dias | Steps 1-5 | PENDENTE |
| 7 | 09 | Escrita do paper | 3-5 dias | Steps 1-6 | PENDENTE |
...
- [STEP05A_classificacao_hierarquica.md](STEP05A_classificacao_hierarquica.md) — **CORE do paper**
- [STEP04B_ablacao_significancia.md](STEP04B_ablacao_significancia.md)
- [STEP05B_logo_cv.md](STEP05B_logo_cv.md)
- [STEP06_mechdetect_original.md](STEP06_mechdetect_original.md)
- [STEP07_pklm.md](STEP07_pklm.md)
- [STEP08_shap_error_analysis.md](STEP08_shap_error_analysis.md)
